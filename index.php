...
<body>
    ...
    <section id="mid">
        <section class="kategorija">
            ...
            <div class="red">
            <?php 
                $query = "SELECT * FROM vijesti WHERE arhiva=0 AND kategorija='Nogomet' ORDER BY id DESC LIMIT 3"; 
        ...
        <section class="kategorija">
            ...
            <div class="red">
            <?php 
                $query = "SELECT * FROM vijesti WHERE arhiva=0 AND kategorija='Košarka' ORDER BY id DESC LIMIT 3"; 
                $result = mysqli_query($dbc, $query); 
                $i=0; 
                while($row = mysqli_fetch_array($result)) {  
                    echo '<div class="clanak">'; 
        ...
        <section class="kategorija">
            <h2>Ostali sportovi</h2>
            <hr>
            <div class="red">
            <?php 
                $query = "SELECT * FROM vijesti WHERE arhiva=0 AND kategorija='Ostali Sportovi' ORDER BY id DESC LIMIT 3"; 
                $result = mysqli_query($dbc, $query); 
                $i=0; 
                while($row = mysqli_fetch_array($result)) {  
                    echo '<div class="clanak">'; 
